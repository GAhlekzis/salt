...
run_terminal='
for t in "$TERMINAL" st urxvt x-terminal-emulator rxvt termit terminator Eterm aterm gnome-terminal konsole roxterm xfce4-terminal termite lxterminal mate-terminal terminology st xterm; do
